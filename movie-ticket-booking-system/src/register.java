...
public class register extends javax.swing.JFrame {
	...
	private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButton1ActionPerformed
		...
		/**
		 * Statement s; ResultSet rs; try { Class.forName("com.mysql.cj.jdbc.Driver");
		 * conn=DriverManager.getConnection("jdbc:mysql://localhost/movie_booking","root","root");
		 * s=conn.createStatement(); //int i=0,y=0,e=0; //
		 * s=conn.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE,ResultSet.CONCUR_UPDATABLE);
		 * //rs=executeQuery("select * from register"); //a=jTextField1.getText();
		 * /**While (rs.next() && y==0) ; { String p=rs.getString("name");
		 * a=jTextField1.getText(); System.out.println(p+""+a); } System.out.println(e);
